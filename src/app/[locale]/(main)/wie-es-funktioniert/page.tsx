...
export default async function WieEsFunktioniertPage({ params }: Props) {
  setRequestLocale(params.locale);

  // English users → redirect to /en/how-it-works
  if (params.locale === "en") {
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 gap-5">
            {helferSteps.map((step, i) => {
              ...
              return (
                <div key={i} className="flex gap-4 bg-white border border-gray-100 rounded-2xl p-6 shadow-sm hover:shadow-md hover:border-brand-100 transition-all">
      ...
      <div className="max-w-4xl mx-auto px-4"><hr className="border-gray-100" /></div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 gap-5">
            {sucherSteps.map((step, i) => {
              ...
              return (
                <div key={i} className="flex gap-4 bg-white border border-gray-100 rounded-2xl p-6 shadow-sm hover:shadow-md hover:border-blue-100 transition-all">
                  <div className="shrink-0">
      ...
      <section className="py-14 px-4 bg-gray-50">
        <div className="max-w-xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Link href="/register" className="inline-flex items-center justify-center gap-2 bg-brand-500 hover:bg-brand-600 text-white text-sm font-semibold px-6 py-3 rounded-xl transition-colors">
              {t("ctaRegister")}
            </Link>
            <Link href="/listings" className="inline-flex items-center justify-center gap-2 bg-white border border-gray-200 hover:border-brand-300 text-gray-700 text-sm font-semibold px-6 py-3 rounded-xl transition-colors">
              {t("ctaListings")}
            </Link>
          </div>
        </div>
