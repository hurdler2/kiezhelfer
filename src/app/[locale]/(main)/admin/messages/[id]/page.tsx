            ...
            return (
              <div
                ...
                className={`flex items-start gap-2 px-3 py-2 rounded-lg border text-sm ${
                  isReported ? "border-red-200 bg-red-50" : "border-gray-200 bg-gray-50"
                }`}
              >
                ...
                >
                  <div
                    className={`h-7 w-7 rounded-full shrink-0 flex items-center justify-center text-xs font-bold mt-0.5 ${
                      isReported ? "bg-red-200 text-red-700" : "bg-gray-200 text-gray-600"
                    }`}
                  >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-0.5">
                      <span
                        className={`text-xs font-semibold ${isReported ? "text-red-700" : "text-gray-800"}`}
                      >
                        {msg.sender.name ?? "—"}
                        {isReported && (
