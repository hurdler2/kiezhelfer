    ...
    <div className="flex items-center gap-1.5">
      {currentStatus !== "APPROVED" && (
        <button
          ...
          title="Onayla"
          className="p-1.5 rounded-lg border text-xs font-medium transition-colors flex items-center gap-1 bg-green-50 border-green-200 text-green-700 hover:bg-green-100"
        >
      ...
      {currentStatus !== "REJECTED" && (
        <button
          ...
          disabled={loading !== null}
          title="Reddet"
          className="p-1.5 rounded-lg border text-xs font-medium transition-colors flex items-center gap-1 bg-red-50 border-red-200 text-red-700 hover:bg-red-100"
        >
      ...
      <button
        ...
        disabled={loading !== null}
        title="Kalıcı Sil"
        className="p-1.5 rounded-lg border text-xs font-medium transition-colors flex items-center gap-1 bg-gray-50 border-gray-200 text-gray-600 hover:bg-red-50 hover:border-red-200 hover:text-red-700"
      >
